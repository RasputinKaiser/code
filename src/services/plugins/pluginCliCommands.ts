 ...
 * ncode_plugin_command_failed before exit so dashboards can compute a
...
function handlePluginCommandError(
  ...
  const telemetryFields = plugin
    ...
    : {}
  logEvent('ncode_plugin_command_failed', {
    command:
...
export async function installPlugin(
  ...
  try {
    ...
    logEvent('ncode_plugin_installed_cli', {
      _PROTO_plugin_name:
        name as AnalyticsMetadata_I_VERIFIED_THIS_IS_PII_TAGGED,
      ...(marketplace && {
        _PROTO_marketplace_name:
...
export async function uninstallPlugin(
  ...
  try {
    ...
    logEvent('ncode_plugin_uninstalled_cli', {
      _PROTO_plugin_name:
        name as AnalyticsMetadata_I_VERIFIED_THIS_IS_PII_TAGGED,
      ...(marketplace && {
        _PROTO_marketplace_name:
...
export async function enablePlugin(
  ...
  try {
    ...
    logEvent('ncode_plugin_enabled_cli', {
      _PROTO_plugin_name:
        name as AnalyticsMetadata_I_VERIFIED_THIS_IS_PII_TAGGED,
      ...(marketplace && {
        _PROTO_marketplace_name:
...
export async function disablePlugin(
  ...
  try {
    ...
    logEvent('ncode_plugin_disabled_cli', {
      _PROTO_plugin_name:
        name as AnalyticsMetadata_I_VERIFIED_THIS_IS_PII_TAGGED,
      ...(marketplace && {
        _PROTO_marketplace_name:
...
export async function updatePluginCli(
  ...
  try {
    ...
    if (!result.alreadyUpToDate) {
      ...
      logEvent('ncode_plugin_updated_cli', {
        _PROTO_plugin_name:
          name as AnalyticsMetadata_I_VERIFIED_THIS_IS_PII_TAGGED,
        ...(marketplace && {
          _PROTO_marketplace_name:
